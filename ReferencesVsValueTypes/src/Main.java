...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("myIntArray = " + Arrays.toString(myIntArray));                  //toString converts the array to a string separating the elements with a comma
        ...
        System.out.println("After modification anotherIntArray = " + Arrays.toString(anotherIntArray));
    }
